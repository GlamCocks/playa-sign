...
class BlinkingStarsLetter(object):
    ...
    def render(self):
        self._clock = (self._clock + 0.05) % 360
        self.renderPixels()

    def renderPixels(self):
        for star in self._stars:
            star.next(delta_hue=self._clock)
